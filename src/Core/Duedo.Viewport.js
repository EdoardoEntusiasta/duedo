...
Duedo.Viewport.prototype.UpdateTranslation = function () {
	...
	if( this.Deadzone )
	{
		this._Edge = this.Target.Location.X - this.Deadzone.Location.X;
		...
		this._Edge = this.Target.Location.Y - this.Deadzone.Location.Y;
	...
	{
		this.FocusOnXY( this.Target.Location.X, this.Target.Location.Y );
	}
