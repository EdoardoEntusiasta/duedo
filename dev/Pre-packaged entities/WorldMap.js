 ...
 * https://github.com/rheh/HTML5-canvas-projects/blob/ae809abed6d4d0536419af0972a223f8f14d7ea6/map/map.js#L163
 */

const WorldEntity = new Duedo.Entity(game);

WorldEntity.iMAP_HEIGHT = 890;
WorldEntity.iMAP_START_Y_POS = 0;
WorldEntity.iMAP_START_X_POS = 0;
WorldEntity.iMAP_WIDTH = 2000;

/**
 * Update
 * void
 */
WorldEntity.Update = function () {};

/**
 * DegreesOfLatitudeToScreenY
 * @param {*} iDegreesOfLatitude 
 * @returns 
 */
WorldEntity.DegreesOfLatitudeToScreenY = function(iDegreesOfLatitude) {
...
/**
 * DegreesOfLongitudeToScreenX
 * @param {*} iDegreesOfLongitude 
 * @returns 
 */
WorldEntity.DegreesOfLongitudeToScreenX = function(iDegreesOfLongitude) {
    // Make the value positive, so we can calculate the percentage
 ...
 * @param {*} ctx 
 */
WorldEntity.Draw = function(ctx) {
    var landMass = game.Cache.GetJSON("worldmap"),
      iFirstScreenX = 0,
      iFirstScreenY = 0,
      shape,
      iLat,
